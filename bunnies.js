...
function endGame()
{
	...
	var verb = _("Number of bunnies blooming");
	
	switch (randomMessage)
	{
		case 1:
			verb = _("Number of bunnies flowering");
			break;
		case 2:
			verb = _("Number of bunnies blossoming");
			break;
		case 3:
			verb = _("Number of bunnies sprouting");
			break;
		case 4:
			verb = _("Number of bunnies flourishing");
			break;
	}
	...
	message.innerHTML += ('<input class="button" id="stopButton" type="button" value="'+_('time for a nap!')+ '"onClick="stop()">');
